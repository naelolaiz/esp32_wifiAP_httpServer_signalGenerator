...
{
  /*
  SPI.beginTransaction(SPISettings(14000000, MSBFIRST, SPI_MODE0)); // communicated by Timothy Corcoran
  //SPI.beginTransaction(SPISettings(3500000, MSBFIRST, SPI_MODE3));  // communicated by Stephen Avis
